  ...
  const [newsItems, setNewsItems] = useState([
    {
      ...
      content:
        "Main Street will be closed for maintenance from July 20 to July 25.",
      date: "2023-07-14",
      isBreaking: true,
      isTrending: false,
      ...
      comments: [
        {
          id: 1,
          author: "John Doe",
          content: "Will there be alternative routes?",
          date: "2023-07-15",
          votes: 5,
        },
        {
    ...
    },
    {
      ...
      content:
        "The new community center will open its doors next month with free activities for all residents.",
      date: "2023-07-10",
      isBreaking: false,
      isTrending: true,
      ...
      comments: [
        {
          ...
          content: "Looking forward to the yoga classes!",
          date: "2023-07-11",
          votes: 7,
        },
      ],
    },
    {
      ...
      content:
        "Due to drought conditions, residents are asked to limit water usage for the next 30 days.",
      date: "2023-07-05",
      isBreaking: false,
      isTrending: false,
