            ...
            <div className="bg-white dark:bg-navy-800 p-4 rounded-xl shadow-md">
              ...
              <div className="mb-4">
                ...
                <input 
                  ...
                  onChange={handleInputChange}
                  className="mt-2 flex h-12 w-full items-center justify-center rounded-xl border border-gray-200 bg-white/0 p-3 text-sm outline-none dark:!border-white/10 dark:text-white focus:border-brand-500 dark:focus:border-brand-400 transition-colors"
                />
              </div>
