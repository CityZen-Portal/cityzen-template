      ...
      <div className="p-5">
        <div className="flex justify-between items-center mb-6">
          ...
          <button 
            ...
            className="px-4 py-2 rounded-xl bg-white text-navy-700 dark:bg-navy-700 dark:text-white hover:bg-gray-100 dark:hover:bg-navy-600 shadow-md transition-all duration-200"
          >
            Close
          </button>
        </div>
