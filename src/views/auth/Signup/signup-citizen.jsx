    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Enter your details to create a new citizen account</p>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#f4f7fe] items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center text-[#1b254b] z-10 px-12">
          ...
          {/* Content */}
          <h2 className="text-4xl font-bold mb-4 text-[#1b254b]">Welcome to CityZen</h2>
          ...
          <div className="space-y-4 text-left max-w-md mx-auto">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-[#1b254b]">Report civic issues instantly</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-6 h-6 bg-[#422afb] bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm">
                <svg className="w-4 h-4 text-[#422afb]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-[#1b254b]">Track resolution progress</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-6 h-6 bg-[#422afb] bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm">
                <svg className="w-4 h-4 text-[#422afb]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-[#1b254b]">Connect with your community</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-6 h-6 bg-[#422afb] bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm">
                <svg className="w-4 h-4 text-[#422afb]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-[#1b254b]">Make a real difference</span>
            </div>
          </div>
