...
export default function RoleSelection() {
  ...
  if (role === "client") return <SignInClient onBack={() => setRole("")} />;
  if (role === "staff") return <SignInStaff onBack={() => setRole("")} />;
    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-white dark:bg-navy-900 relative overflow-hidden px-4 py-8 transition-colors duration-300">
      ...
      >
        <svg width="20" height="20" fill="none" viewBox="0 0 20 20" className="mr-2">
          <path d="M7.707 4.293a1 1 0 00-1.414 1.414L9.586 9H18a1 1 0 100 2H9.586l2.707 2.707a1 1 0 01-1.414 1.414l-5-5a1 1 0 010-1.414l5-5z" fill="currentColor"/>
        </svg>
        Back
      </button>
      {/* Decorative Circles */}
